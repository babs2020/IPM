...
require_once 'config.php'; // On inclu la connexion à la bdd
    ...
    $pdoStart= $objet->prepare('INSERT INTO preinscription VALUES(NULL,:nom,:prenom,:email,:numero,:genre,:formation,:niveau,:motivation)');  /* pdo: connecter a la base */
    ...
    $pdoStart->bindvalue(':genre',$_POST['genre'],PDO::PARAM_STR);
    $pdoStart->bindvalue(':formation',$_POST['formation'],PDO::PARAM_STR);
    $pdoStart->bindvalue(':niveau',$_POST['niveau'],PDO::PARAM_STR);
    $pdoStart->bindvalue(':motivation',$_POST['motivation'],PDO::PARAM_STR);
